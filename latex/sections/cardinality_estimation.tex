...
\subsubsection{Union} \label{subsubsec:hll-union}
...
\begin{theorem}[Algebraic Properties of the Union Operation \cite{Heule2013HyperLogLogIP}] \label{thm:hll-union-properties}
